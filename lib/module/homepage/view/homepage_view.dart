      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            _buildCategoryItem('Woman Shoes', 'assets/woman_shoes.png'),
            _buildCategoryItem('Whitening', 'assets/whitening_treatment.png'),
            _buildCategoryItem('One Day Order', 'assets/one_day_order.png'),
          ],
        ),
      ],
    );
